...
```{r message=FALSE, warning=FALSE, label= "simulate-data"}
...
```{r message=FALSE, warning=FALSE, label= "calculate-reported-incidence"}
...
```{r message=FALSE, warning=FALSE, label= "plot_EU1"}
...
```{r message=FALSE, warning=FALSE, label= "plot-RK1"}
...
```{r message=FALSE, warning=FALSE, label= "compare-param-1"}
compare_param_est(
...
```{r message=FALSE, warning=FALSE, label= "plot-EU2"}
...
```{r message=FALSE, warning=FALSE, label= "compare-param-2"}
compare_param_est(
